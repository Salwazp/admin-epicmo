...
<div class="content-header row">
            ...
            <div class="col-12">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Moment</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="content-body">
        <section class="bs-validation">
            @if ($data !== null)
            <form action="{{ route('admin.moment.update', $data->id) }}" method="POST" enctype="multipart/form-data"> <!-- jika form tambah -->
            @else
            <form action="{{ route('admin.moment.store') }}" id="jquery-val-form" method="POST" enctype="multipart/form-data"> <!-- jika form edit -->
            @endif
                @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" class="form-control @error('date') border-danger @enderror" value="{{ $data ? $data->date : '' }}">
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
