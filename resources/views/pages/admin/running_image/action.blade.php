...
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ request()->route("admin.running_image") }}">Clients</a>
                            </li>
                            <li class="breadcrumb-item active">
                                @if ($data == null)
                                Create Clients
                                @else
                                Update Clients: {{ $data->text }}
                                @endif
                            </li>
                        </ol>
                    </div>
    ...
    <!-- Validation -->
        <section class="bs-validation">
            @if ($data !== null)
            <form action="{{ route('admin.running_image.update', $data->id) }}" method="POST" enctype="multipart/form-data"> <!-- jika form tambah -->
            @else
            <form action="{{ route('admin.running_image.store') }}" id="jquery-val-form" method="POST" enctype="multipart/form-data"> <!-- jika form edit -->
            @endif
                @csrf
                <div class="row">
                                            ...
                                            <div class="file-upload  @error('image') border-danger @enderror">
                                                ...
                                                <div class="image-upload-wrap">
                                                    ...
                                                    <div class="drag-text">
                                                        ...
                                                        @else
                                                        <h3>Drag and drop a file or select add image</h3>                                                        @endif
                                                    </div>
                                                </div>
