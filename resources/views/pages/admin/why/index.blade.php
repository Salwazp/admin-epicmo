                                    ...
                                    <div class="col-md-12">
                                        <div class="file-upload @error('image') border-danger @enderror" style="width:100%">
                                            ...
                                            <div class="file-upload-content">
                                                <img class="file-upload-image" src="{{ $data && $data->image ? Storage::url($data->image) : '' }}" alt="your image" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if($data && isset($data->value['icon1']))
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($data->value['icon1']) }}" alt="Icon 1" style="max-width: 50px; max-height: 50px;">
                                        </div>
                                    @endif
                                    @error('icon1')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($data && isset($data->value['icon2']))
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($data->value['icon2']) }}" alt="Icon 2" style="max-width: 50px; max-height: 50px;">
                                        </div>
                                    @endif
                                    @error('icon2')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($data && isset($data->value['icon3']))
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($data->value['icon3']) }}" alt="Icon 3" style="max-width: 50px; max-height: 50px;">
                                        </div>
                                    @endif
                                    @error('icon3')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($data && isset($data->value['icon4']))
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($data->value['icon4']) }}" alt="Icon 4" style="max-width: 50px; max-height: 50px;">
                                        </div>
                                    @endif
                                    @error('icon4')
                                        <span class="text-danger">{{ $message }}</span>
