    ...
    (b.prototype.init = function () {
      ...
      (b.prototype.isVideo = function (a, b) {
        ...
        if (((c = this.s.dynamic ? this.s.dynamicEl[b].html : this.$items.eq(b).attr("data-html")), !a))
          return c
            ? { html5: !0 }
            : (console.error(
                "lightGallery :- data-src is not provided on slide item " + (b + 1) + ". Please make sure the selector property is properly configured. More info - http://sachinchoolur.github.io/lightGallery/demos/html-markup.html"
              ),
              !1);
      ...
      (b.prototype.addHtml = function (b) {
        ...
        if (
          (this.s.dynamic
            ...
            : ((d = this.$items.eq(b)), d.attr("data-sub-html-url") ? (c = d.attr("data-sub-html-url")) : ((e = d.attr("data-sub-html")), this.s.getCaptionFromTitleOrAlt && !e && (e = d.attr("title") || d.find("img").first().attr("alt")))),
          !c)
        )
          if (void 0 !== e && null !== e) {
      ...
      (b.prototype.loadContent = function (b, c, d) {
        ...
        if (l.s.dynamic) {
          ...
          var o = l.$items.eq(b);
          if (
            (o.attr("data-poster") && ((m = !0), (g = o.attr("data-poster"))), (j = o.attr("data-html")), (f = o.attr("href") || o.attr("data-src")), (k = o.attr("title") || o.find("img").first().attr("alt")), o.attr("data-responsive"))
          ) {
        ...
        if (!l.$slide.eq(b).hasClass("lg-loaded")) {
          if (p)
            l.$slide
              .eq(b)
              .prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + l.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + f + '"  allowfullscreen="true"></iframe></div></div>');
          else if (m) {
            var r = "";
        ...
        b.s.enableDrag &&
          ...
          (b.$slide.on("mousedown.lg", function (d) {
            b.$outer.hasClass("lg-zoomed") ||
              ...
              (d.preventDefault(), b.manageSwipeClass(), (c = d.pageX), (e = !0), (b.$outer.scrollLeft += 1), (b.$outer.scrollLeft -= 1), b.$outer.removeClass("lg-grab").addClass("lg-grabbing"), b.$el.trigger("onDragstart.lg"));
          }),
